...
use App\Exports\PosRebateExternalExport;
...
class ExportRebateReportController extends ExportController
{
  public function byCompanyRebate(Request $request)
  {
    ...
    return $this->exportResponse($data, PosRebateExternalExport::class);
  }
