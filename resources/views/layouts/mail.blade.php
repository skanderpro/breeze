                                            ...
                                            <td class="pad" style="width: 100%">
                                                ...
                                                >
                                                    <div style="max-width: 390px">
                                                        <img
                                                            height="auto"
                                                            src="{{ url('images/Express_Merchants_EM_Long_Logo_NoStrapline-rgb.png') }}"
                                                            style="
                                          display: block;
                                          height: auto;
                                          border: 0;
                            ...
                            "
                                            ...
                                            <td class="pad" style="width: 100%">
                                                ...
                                                >
                                                    <div style="max-width: 457px">
                                                        <img
                                                            height="auto"
                                                            src="{{ url('images/Express_Merchants_EM_Long_Logo_NoStrapline-rgbrev_2125.png') }}"
                                                            style="
                                          display: block;
                                          height: auto;
                                          border: 0;
                              ...
                              "
                                    ...
                                    >
                                      ...
                                      line-height: 150%;
                                      text-align: left;
                                      mso-line-height-alt: 34.5px;
                                    "
                                                >
                                                    <p style="margin: 0">
                                                        Millions of products, Thousands of
                                                        locations,
                                                        <strong
                                                        ><span
                                                                style="
                                                        ...
                                                        <tr>
                                                            <td style="padding: 0 10px 0 10px">
                                                                ...
                                                                ><img
                                                                        alt="Facebook"
                                                                        height="auto"
                                                                        src="{{ url('images/FacebookIcon.png') }}"
                                                                        style="
                                                display: block;
                                                height: auto;
                                                border: 0;
                                              ...
                                              "
                                                            ...
                                                            <td style="padding: 0 10px 0 10px">
                                                                ...
                                                                ><img
                                                                        alt="Linkedin"
                                                                        height="auto"
                                                                        src="{{ url('images/LinkedInIcon.png') }}"
                                                                        style="
                                                display: block;
                                                height: auto;
                                                border: 0;
                              ...
                              "
                                    ...
                                    "
                                                >
                                                    <p style="margin: 0">
                                                        Unit 7, Brownstown Business Centre,<br />Portadown,
                                                        Co Armagh BT62 4EA
                                                    </p>
                                                </div>
                                            </td>
