    ...
    */
    ...
    storeLocator.Panel = function(a, b) {
        ...
        this.settings_ = $.extend({
            locationSearch: !0,
            locationSearchLabel: "Search by <span>Location or Supplier</span>",
            featureFilter: !0,
            directions: !0,
            view: null
        }, b);
    ...
    storeLocator.Panel.prototype.init_ = function() {
        ...
        if (this.settings_.featureFilter) {
            this.featureFilter_ = $('<p><a class="filter" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"> Filter by type </a></p><div class="collapse" id="collapseExample"><div class="feature-filter">');
        ...
        this.settings_.directions && (this.directionsPanel_ = $('<div class="directions-panel"><form>' +
            '<input class="directions-to"/>' +
            '<input type="submit" value="Find directions"/>' +
            '<a href="#" class="close-directions">Close</a>' +
            '</form><div class="rendered-directions"></div></div></div>'), this.directionsPanel_.find(".directions-to").attr("readonly", "readonly"), this.directionsPanel_.hide(),
    ...
    storeLocator.Panel.NO_STORES_IN_VIEW_HTML_ = '\x3cli class\x3d"no-stores"\x3eThere are no stores in this area. However, stores closest to you are listed below.<br /><a href="po-create?unlisted">Create PO from unlisted retailer</a>\x3c/li\x3e';
